...
class WordPrinterTest {
   ...
   * interfaces on iOS and Android in record time. Flutter works with existing
   * code, is used by developers and organisations around the world, and is free
   * and open source.
   */
  ...
  void testPrintingWordsFromText() {
    try (Scanner scanner = new Scanner(System.in)) {
      assertEquals(
          "    app and Android and around and and \n"
              + "    by \n    crafting code \n    developers \n"
  ...
  @Test
  void testCheckPrintedWordsFromText() {
    assertEquals(
        "    app and Android and around and and \n"
            + "    by \n    crafting code \n    developers \n"
            + "    existing \n    Flutter for Flutter free \n"
            ...
            + "    quality \n    record \n    SDK source \n"
            + "    time the \n    used \n    works with world \n    ",
        WordPrinter.orderWordsFromTextAlphabetically(
